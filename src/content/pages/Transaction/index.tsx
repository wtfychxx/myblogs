                                            ...
                                            tableData.map((entry, i) => {
                                                return(
                                                    <Grid item xs={12} sm={6} md={4} lg={3}>
                                                        <Box sx={{ textDecoration: 'none' }} component={RouterLink} to={`/product/${entry.id}`}>
                                                            <Card sx={{ cursor: 'pointer' }}>
                                                                ...
                                                                <CardActions>
                                                                    <Typography variant="body1">
                                                                        <StarIcon fontSize="medium" sx={{ color: yellow[700] }} />
                                                                    </Typography>
                                                                    <Typography variant="subtitle2">3.5</Typography>
                                                                    {
                                                                        (!entry.cashOnly) ? <Typography variant="inherit" sx={{ marginLeft: 'auto' }}> Dapat dikredit </Typography> : null
                                                                    }
                                                                </CardActions>
                                                            </Card>
                                                        </Box>
